...
public class AppService extends Service {
                ...
                new ChildEventListener() {
                    ...
                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                        if (LocalUserService.getLocalUserFromPreferences(getApplicationContext()).Email != null) {
                            ...
                            String mess = "Google Calendar is updating";//map.get("Message").toString();
                            String senderEmail = "please update"; //map.get("SenderEmail").toString();
    ...
    private void notifyUser(String friendEmail, String senderFullName, String mess, int notificationType) {
        ...
        not.setSmallIcon(R.drawable.gc);
        not.setContentText("Google ads update");
